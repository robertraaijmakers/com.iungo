...
import { IungoApp, IungoDevice, EnergySettings } from '../../types/types';

const deviceType = 'evcharger';

module.exports = class DeviceCarChargerMeter extends Homey.Device {
  async onInit() {
